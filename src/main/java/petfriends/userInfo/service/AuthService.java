...
public class AuthService {
    ...
    public UserInfoResponseDto signup(UserInfoRequestDto userInfoRequestDto) {
      System.out.println("3333333333333333");
        ...
        UserInfo userInfo = userInfoRequestDto.toUserInfo(passwordEncoder);
        return UserInfoResponseDto.of(userInfoRepository.save(userInfo));
    }

    @Transactional
    public TokenDto login(UserInfoRequestDto uesrInfoRequestDto) {
        // 1. Login ID/PW 를 기반으로 AuthenticationToken 생성
        UsernamePasswordAuthenticationToken authenticationToken = uesrInfoRequestDto.toAuthentication();
